...
2. The scenes folder contain all the player, enemeis and level scenes.
3. The examplescenes folder will contain the templates of menu options.
4. Open this project in Godot and press play. 
